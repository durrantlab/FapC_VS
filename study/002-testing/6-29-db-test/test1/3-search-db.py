...
LIB_PATH: Path = (Path(__file__) / ".." / ".." / ".." / ".." / "033-pharm-search-top-div" / "analysis").resolve()
...
def main(pharm_list_file: Path, pharm_db_dir: Path, pharmit_output_dir: Path, 
    ...
    iterative_pharm.main(pharm_list_file, pharm_db_dir, pharmit_output_dir, temp_dir, max_mol)
