...
def main(docked_dir: Path, csv_op_file: Path):
    ...
    sorted_best: list[dict] = sorted(best_for_each, key=lambda x: x["cnn_vs"], reverse=True)
...
if __name__ == "__main__":
    ...
    csv_op_file: Path = Path(DIR_STUDY / "025-filter-gnina-op" / "data" / "ranked_docked_mols.csv")
