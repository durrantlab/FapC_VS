...
def enable_logging(
    ...
    logger.enable("FapC_VS")


if literal_eval(os.environ.get("FapC_VS_LOG", "False")):
    level = int(os.environ.get("FapC_VS_LOG_LEVEL", 20))
    stdout = literal_eval(os.environ.get("FapC_VS_STDOUT", "True"))
    log_file_path = os.environ.get("FapC_VS_LOG_FILE_PATH", None)
